...
| | |
| --- | --- |
| **Packaged app version** | `0.3.5` (see [`dozzle/config.yaml`](dozzle/config.yaml)) |
| **Bundled Dozzle binary** | `v10.5.3` (see [`dozzle/Dockerfile`](dozzle/Dockerfile)) |
...
[release]: https://github.com/Erreur32/homeassistant-dozzle/releases/tag/v0.3.5
