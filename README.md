...
| | |
| --- | --- |
| **Packaged app version** | `0.3.9` (see [`dozzle/config.yaml`](dozzle/config.yaml)) |
| **Bundled Dozzle binary** | `v10.6.5` (see [`dozzle/Dockerfile`](dozzle/Dockerfile)) |
...
[release-shield]: https://img.shields.io/badge/version-v0.3.9-blue.svg
[release]: https://github.com/Erreur32/homeassistant-dozzle/releases/tag/v0.3.9
